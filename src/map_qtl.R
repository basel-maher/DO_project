...
load(file = "./results/Rdata/k_loco_basic_cleaned_pseudo.Rdata") #LOCO
...
#paste0(colnames(norm_pheno),"_LOGTRANS")

#which traits require FL as covar? bending traits?
DO_qtl_scan = scan1(apr, cross_basic$pheno[,c(5:70,72,74,76)], k_loco, Xcovar=Xcovar, addcovar = covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33")],cores = 0)
save(DO_qtl_scan,file = "./results/Rdata/DO_qtl_scan.Rdata")


DO_qtl_scan_binary = scan1(apr, cross_basic$pheno[,c(71,73,75,77)], Xcovar=Xcovar, addcovar = covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33")],cores = 0)
...
####try while Normal####
norm_pheno = as.data.frame(log10(cross_basic$pheno[,c(5:14,16,17,21,23:32,34,35,37:41,43:49,51,52,54:58,60:70,72,74,76)]+0.0000001))
pheno_combined = cbind(norm_pheno, cross_basic$pheno[,c(15,18,19,20,22,33,36,42,50,53,59)])
new_covar = covar
new_covar[,c(2,3)] = log10(new_covar[,c(2,3)]+0.0000001)
DO_qtl_scan_normal = scan1(apr, pheno_combined, k_loco, Xcovar=Xcovar, addcovar = new_covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33")],cores = 0)
save(DO_qtl_scan_normal,file = "./results/Rdata/DO_qtl_scan_norm.Rdata")

DO_qtl_scan_binary_norm = scan1(apr, cross_basic$pheno[,c(71,73,75,77)], Xcovar=Xcovar, addcovar = new_covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33")])
...
perm = scan1perm(apr, cross_basic$pheno[,c(5:70,72,74,76)], k_loco, Xcovar=Xcovar, addcovar = covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33")],n_perm = 1000,perm_Xsp = TRUE, cores=0)
