...
write.table(coloc_7_all_results,"~/Documents/projects/DO_project/results/flat/coloc/coloc_morris_v7_all_results.txt",sep = "\t",quote = FALSE)
...
coloc_7_all_results$gene = as.character(coloc_7_all_results$gene)
write.table(coloc_7_all_results,"~/Documents/projects/DO_project/results/flat/coloc/coloc_estrada_v7_all_results.txt",sep = "\t",quote = FALSE)
...
write.table(fn,"~/Documents/projects/DO_project/results/flat/coloc/coloc_v7_FNBMD_over75.txt",sep = "\t",quote = FALSE)
