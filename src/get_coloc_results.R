...
coloc_results_files =list.files(path= "~/Documents/projects//DO_project/results/flat/coloc/coloc_morris_results_REV/", pattern = "coloc_results*")
...
for (i in coloc_results_files){
  ...
  result = read.delim(paste("~/Documents/projects//DO_project/results/flat/coloc/coloc_morris_results_REV/",i,sep = ""),as.is = TRUE,stringsAsFactors = FALSE,header = FALSE,sep=" ")
  result = result[-1,]
...
gene_list = read.table("~/Documents/projects//DO_project/results/flat/coloc/morris_lead_BAN_overlaps_REV.txt")
...
write.table(coloc_7_all_results,"~/Documents/projects/DO_project/results/flat/coloc/coloc_morris_v7_all_results_REV.txt",sep = "\t",quote = FALSE)

coloc_7_all_results_over75 = coloc_7_all_results[which(coloc_7_all_results$H4 >=0.75),] 

morris_ovr75  = coloc_7_all_results_over75
write.table(coloc_7_all_results_over75,"~/Documents/projects/DO_project/results/flat/coloc/coloc_morris_v7_all_results_over75_REV.txt",sep = "\t",quote = FALSE)
...
coloc_results_files =list.files(path= "~/Documents/projects//DO_project/results/flat/coloc/coloc_estrada_results_REV/", pattern = "coloc_results*")

coloc_7_all_results = data.frame()
for (i in coloc_results_files){
  result = read.delim(paste("~/Documents/projects//DO_project/results/flat/coloc/coloc_estrada_results_REV/",i,sep = ""),as.is = TRUE,stringsAsFactors = FALSE,header = FALSE,sep=" ")
  result = result[-1,]
  result = result[which(is.na(result$V2)==FALSE),]
  coloc_7_all_results=rbind(coloc_7_all_results,result)
}
...
gene_list = read.table("~/Documents/projects//DO_project/results/flat/coloc/estrada_lead_BAN_overlaps_REV.txt")
...
coloc_7_all_results$gene = as.character(coloc_7_all_results$gene)
write.table(coloc_7_all_results,"~/Documents/projects/DO_project/results/flat/coloc/coloc_estrada_v7_all_results_REV.txt",sep = "\t",quote = FALSE)
...
write.table(fn,"~/Documents/projects/DO_project/results/flat/coloc/coloc_v7_FNBMD_over75_REV.txt",sep = "\t",quote = FALSE)
write.table(ls,"~/Documents/projects/DO_project/results/flat/coloc/coloc_v7_LSBMD_over75_REV.txt",sep = "\t",quote = FALSE)
